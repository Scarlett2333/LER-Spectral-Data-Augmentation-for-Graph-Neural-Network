...
# from igraph import *
def reduction(reductionTarget,actionSwitch,numSamplesS,qOverS,minProbPerActionD,minTargetItems,plotError,iHaveIGraph,edges,edgeWeights):
...
# ##########################################
	...
	g = GLGraph(edges, edgeWeights=edgeWeights, nodeWeights='none', plotError=plotError, layout='random')
	...
	return 	g.edgeList,g.edgeWeightList																		# $V \times V$. Use this to get approximate solutions to your Lx=b problems.
